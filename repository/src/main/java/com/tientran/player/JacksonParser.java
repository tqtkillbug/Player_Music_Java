...
public class JacksonParser {
    ...
    public <T> List<T> toList(String jsonString, Class<T> cls) throws JsonParseException {
        ...
        try {
            ...
            throw new JsonParseException(null,"Unnable to parse json string to list/array!", e);
        }
    }
    ...
    public <T> T toObject(String jsonString, Class<T> baseCls, Class<?>... paramCls) throws JsonParseException {
        ...
        try {
            ...
            throw new JsonParseException(null,"Unnable to parse json string to parametric object!", e);
        }
    }
    ...
    public String toJson(Object value) throws JsonParseException {
        try {
            ...
            throw new JsonParseException(null,"Can not parse object to Json!", e);
        }
    }
    ...
    public <T> T toObject(String jsonString, Class<T> cls) throws JsonParseException {
        try {
            ...
            throw new JsonParseException(null,"Unnable to parse json string to object!", e);
        }
    }
}